...
{0x002A, 0x165E},
{0x0F12, 0x0235},           //0244 0258 AWB R point          //0258 0245 0258
{0x0F12, 0x024A},           //024D 0220 AWB B point          //0220 0245 0245
...
{0x002A, 0xF462},
{0x0F12, 0x0001}, // atx_option add 0714

{0x002A, 0xF2A5},
{0x0F12, 0x01FF}, // atx_width  add 0714
...
//=====, 0x==============================================================
// AWB , 0xwhite locus setting - Have to be written after TnP
//=====, 0x==============================================================
{0x0028, 0x7000},
{0x002A, 0x1014},
...
//4.  A, 0xF Peak Threshold Setting
{0x002A, 0x1498},
...
// AF S, 0xcene Settings
{0x002A, 0x151E},
{0x0F12, 0x0003},          //#af_scene_usSaturatedScene

//7. AF, 0x Lens Position Table Settings
{0x002A, 0x1434},
...
//8. VC, 0xM AF driver with PWM/I2C 
{0x002A, 0x1558},
...
{0x0F12, 0x0008},          //#afd_usParam[6]  SlowMotion Threshold
...
{0x002A, 0x0ED2},
{0x0F12, 0x0FA0},	                  //setot_uOnlineClocksDiv40

//=====, 0x==============================================================
// Prev, 0xiew subsampling mode
//=====, 0x==============================================================
{0x002A, 0x18F8},
...
//=====, 0x==============================================================
// PLL , 0xsetting for Max frequency (EVT0.1) 2010.08.05 - Do not remove
//=====, 0x==============================================================
{0x002A, 0x19AE},
...
//SCLK , 0x& PCLK
{0x0F12, 0x34BC},	//REG_TC_IPRM_OpClk4KHz_0  38A4:58Mhz	32C8//52Mhz	//2EE0	//48Mhz 1F40	//32MHz
{0x0F12, 0x3A98}, //s32C8//s34BC	//REG_TC_IPRM_MinOutRate4KHz_0	//53.936Mhz	//32A8	//51.872MHz
{0x0F12, 0x3A98}, //s36B0//s34BC	//REG_TC_IPRM_MaxOutRate4KHz_0	//54.064Mhz	//32E8	//52.128MHz
{0x002A, 0x01CC},
...
//=====, 0x==============================================================
// Prev, 0xiew 0 640 480 system 52M PCLK 54M
//=====, 0x==============================================================
{0x002A, 0x023E},
{0x0F12, 0x0280}, //REG_0TC_PCFG_usWidth 400
{0x0F12, 0x01e0}, //REG_0TC_PCFG_usHeight 300
{0x0F12, 0x0005}, //REG_0TC_PCFG_Format
{0x0F12, 0x3A98}, //s36B0//s34BC	//REG_0TC_PCFG_usMaxOut4KHzRate
{0x0F12, 0x3A98}, //s32C8//s34BC	//REG_0TC_PCFG_usMinOut4KHzRate

{0x002A, 0x024C},
{0x0F12, 0x0002}, // aiden //0x12 REG_0TC_PCFG_PVIMask    => cmk 2010.10.29 s0042 => s0052 Invert Y C order
...
//=====, 0x==============================================================
// Capt, 0xure 0 2048x1536 system 52M PCLK 54M
//=====, 0x==============================================================
...
{0x0F12, 0x3A98}, //s36B0//s34BC	//REG_0TC_CCFG_usMaxOut4KHzRate
{0x0F12, 0x3A98}, //s32C8//s34BC	//REG_0TC_CCFG_usMinOut4KHzRate

{0x002A, 0x033E},
{0x0F12, 0x0002}, // aiden 0x12                   //REG_0TC_CCFG_PVIMask        => cmk 2010.10.29 s0042 => s0052 Invert Y C order
{0x0F12, 0x0010},                   //REG_0TC_CCFG_OIFMask
//0F120, 0x3C0},                   //REG_0TC_CCFG_usJpegPacketSize
...
{0x002A, 0x1E5C},            //Mon_LT_uDefMinFrExpDelta
{0x0F12, 0x0000},
...
//=====, 0x==============================================================
// Shad, 0xing (AF module)
//=====, 0x==============================================================
// TVAR, 0x_ash_pGAS_high
{0x002A, 0x0D22},
{0x0F12, 0x0F00},
{0x0F12, 0x000F},
{0x0F12, 0x000F},
...
// Gamm, 0xa
//=====, 0x==============================================================
//	par, 0xam_start	SARR_usGammaLutRGBIndoor
{0x002A, 0x0660},
...
//=====, 0x==============================================================
//*****, 0x***********************************/
// AE 2, 0x009 03 08 - based on TN
//*****, 0x***********************************/
//=====, 0x=======================================================
// Fram, 0xe rate setting
//=====, 0x=======================================================
// How , 0xto set
// 1. E, 0xxposure value
// dec2, 0xhex((1 / (frame rate you want(ms))) * 100d * 5d)
//     , 0x
//     , 0x
// 2. A, 0xnalog Digital gain
// dec2, 0xhex((Analog gain you want) * 256d)
//     , 0x         Ex1) Simple Caculation for x3.25?:   3.25x256 = 832[dec] = 0340[hex]
//=====, 0x=======================================================
//MBR  , 0x
{0x002A, 0x01DE},
{0x0F12, 0x0000}, //REG_TC_bUseMBR//MBR off
//MBR o, 0xff is needed to prevent a shorter integration time when the scene has blurring in Night shot
...
//ae_St, 0xatMode bit[3] BLC has to be bypassed to prevent AE weight change especially backlight scene
...
//AWB-Z, 0xone
//=====, 0x==============================================================
//	par, 0xam_start	awbb_IndoorGrZones_m_BGrid
{0x002A, 0x0F28},
...
//	par, 0xam_end	awbb_IndoorGrZones_m_BGrid
...
//	par, 0xam_start	awbb_OutdoorGrZones_m_BGrid
{0x002A, 0x0F84},
...
//	par, 0xam_end	awbb_OutdoorGrZones_m_BGrid
...
//	par, 0xam_start	awbb_LowBrGrZones_m_BGrid
{0x002A, 0x0FC0},
...
//	par, 0xam_end	awbb_LowBrGrZones_m_BGrid
...
//	par, 0xam_start	TVAR_wbt_pBaseCcms
{0x002A, 0x07C4},
...
//	par, 0xam_end	TVAR_wbt_pBasecms
...
//	par, 0xam_start	TVAR_wbt_pOutdoorCcm
{0x002A, 0x40D8},
...
//	par, 0xam_end	TVAR_wbt_pOutdoorCcm
...
//	par, 0xam_start	afit_uNoiseIndInDoor
{0x002A, 0x085C},
...
{
	{
		...
		{0x002A, 0x043C},
		{0x0F12, 0x0800},	//REG_TC_PZOOM_ZoomInputWidth
		{0x0F12, 0x0558}, //REG_TC_PZOOM_ZoomInputHeight
		{0x0F12, 0x0000},	//REG_TC_PZOOM_ZoomInputWidthOfs
		{0x0F12, 0x0054}, //REG_TC_PZOOM_ZoomInputHeightOfs
