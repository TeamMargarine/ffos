...
//#include <mach/ldo.h>
#if defined (CONFIG_MACH_VASTOI)
#include "sensor_s5k5ccgx_regs_vastoi.h"
#else
...
{
	SENSOR_AVDD_VAL_E dvdd_val = g_s5k5ccgx_yuv_info.dvdd_val;
	SENSOR_AVDD_VAL_E avdd_val = g_s5k5ccgx_yuv_info.avdd_val;
	SENSOR_AVDD_VAL_E iovdd_val = g_s5k5ccgx_yuv_info.iovdd_val;
	BOOLEAN power_down = g_s5k5ccgx_yuv_info.power_down_level;
	BOOLEAN reset_level = g_s5k5ccgx_yuv_info.reset_pulse_level;
