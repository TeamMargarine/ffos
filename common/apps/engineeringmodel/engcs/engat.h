...
#define ENG_AT_CMD_MAX_LEN			1024

#define SEND_ARRAY_MAX_LEN 			512

//the first byte0, byte1 is packet header
#define SEND_DATA_START_POS 			2
#define SEND_DATA_ITEM_LENGTH_BYTES	1
